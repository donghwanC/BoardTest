		...
		<div class="container">
			...
			<section id="container">
				<form name="readForm" role="form" method="post">
					...
					<!-- a태그에 onclick에 함수를 넣어놨는데요.
						파라미터로 파일의 번호를 넘겨주고 그다음 id가 FILE_NO인 
						input태그의 값에 파일의 번호를 넘겨준 후 
				...
				<hr>
				<span>파일 목록</span>
				<div class="form-group" style="borrder: 1px solid #dbdbdb;">
					<c:forEach items="${file }" var="file">
						<a href="#" onclick="fn_fileDown('${file.FILE_NO}')">${file.ORG_FILE_NAME }</a>(${file.FILE_SIZE }kb)<br>
					</c:forEach>
				</div>
				<hr>
				<div>
